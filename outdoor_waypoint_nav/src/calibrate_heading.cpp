...
void writeParams(std::string path_to_param_file, double heading_err)
{
    ...
    // Write to file
        ...
        paramsFile << "  zero_altitude: " << zero_altitude << std::endl;
        paramsFile << "  broadcast_utm_transform: " << broadcast_utm_transform << std::endl;
        paramsFile << "  publish_filtered_gps: " << publish_filtered_gps << std::endl;
        paramsFile << "  use_odometry_yaw: " << use_odometry_yaw << std::endl;
        paramsFile << "  wait_for_datum: " << wait_for_datum << std::endl;
